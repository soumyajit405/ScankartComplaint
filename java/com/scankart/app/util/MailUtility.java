...
{  		
		//Sending Email
		public String sendEmail(String email,String userName,String complaintType, String description){
			  String status="";
			...
			//  final String user="brings.gvn@gmail.com";//change accordingly
			 // final String user="myteamdiscussion@gmail.com";//change accordingly  
			  final String user="violetsky.technologies@gmail.com";
			  
			 //final String password="papun12345";//change accordingly  
			  final String password="Wearesuccessful@2020";
			  ...
			  //Get the session object  
			   ...
			   //Compose the message  
			    try {  
			     ...
			     message.setSubject("Customer Support For "+userName);  
			     message.setText("You have received a new enquiry " +complaintType + " ----  "+ description);  
		...
		public String sendMailToAdmin(String useremail,String message1){
			  String status="";
			 // String host="smtp.gmail.com";  
			  String host="mail.brings.co.in";  
			//  final String user="brings.gvn@gmail.com";//change accordingly
			  ...
			  //Get the session object  
			   ...
			   //Compose the message  
			    try {  
			     ...
			     message.setFrom(new InternetAddress(user));  
			     message.addRecipient(Message.RecipientType.TO,new InternetAddress(to));  
			     message.setSubject("New Delivery Boy registered through webapp");  
			     message.setText("New Delivery Boy registered through webapp  : " + message1);  
		...
		public String sendMailToAdminForContact(String useremail,String message1){
			  String status="";
			 // String host="smtp.gmail.com";  
			  String host="mail.brings.co.in";  
			//  final String user="brings.gvn@gmail.com";//change accordingly
			  ...
			  //Get the session object  
			   ...
			   //Compose the message  
			    try {  
			     ...
			     message.setFrom(new InternetAddress(user));  
			     message.addRecipient(Message.RecipientType.TO,new InternetAddress(to));  
			     message.setSubject("Someone contacted through webapp");  
			     message.setText("Someone  contacted through webapp  : " + message1);  
		...
		public static void main(String[] args)
		{
			...
			mu.sendEmail("avskmurthy@gmail.com", "Test","Test","Test");
		}
